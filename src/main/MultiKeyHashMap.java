...
//CLASE IMPLEMENTADA POR: https://gist.github.com/prathabk/1587699
...
public class MultiKeyHashMap<K1,K2,V> {
    ...
    /**
     * Reescribe el toString para devolver los keys acompañdos del value
     * Complementa el metodo getAllItems()
     * @return key, key, value
     */
    @Override
    public String toString(){
        return mkMap.toString();
    }
}